...
namespace GHB_D1.ReportFiles {
    ...
    public class CDM7001_CDM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.CDM7001_CDM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCDM7001_CDM : Component, ICachedReport {
        
        public CachedCDM7001_CDM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CDM7001_CDM rpt = new CDM7001_CDM();
            rpt.Site = this.Site;
            return rpt;
        }
