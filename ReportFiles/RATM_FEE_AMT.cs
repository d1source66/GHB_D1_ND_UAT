...
namespace GHB_D1.ReportFiles {
    ...
    public class RATM_FEE_AMT : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.RATM_FEE_AMT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRATM_FEE_AMT : Component, ICachedReport {
        
        public CachedRATM_FEE_AMT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RATM_FEE_AMT rpt = new RATM_FEE_AMT();
            rpt.Site = this.Site;
            return rpt;
        }
