...
namespace GHB_D1.ReportFiles {
    ...
    public class LOCATION_LRM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.LOCATION_LRM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLOCATION_LRM : Component, ICachedReport {
        
        public CachedLOCATION_LRM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LOCATION_LRM rpt = new LOCATION_LRM();
            rpt.Site = this.Site;
            return rpt;
        }
