...
namespace GHB_D1.ReportFiles {
    ...
    public class LRM7001_LRM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.LRM7001_LRM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLRM7001_LRM : Component, ICachedReport {
        
        public CachedLRM7001_LRM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LRM7001_LRM rpt = new LRM7001_LRM();
            rpt.Site = this.Site;
            return rpt;
        }
