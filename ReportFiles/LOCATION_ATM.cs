...
namespace GHB_D1.ReportFiles {
    ...
    public class LOCATION_ATM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.LOCATION_ATM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLOCATION_ATM : Component, ICachedReport {
        
        public CachedLOCATION_ATM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LOCATION_ATM rpt = new LOCATION_ATM();
            rpt.Site = this.Site;
            return rpt;
        }
