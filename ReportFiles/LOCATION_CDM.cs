...
namespace GHB_D1.ReportFiles {
    ...
    public class LOCATION_CDM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.LOCATION_CDM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLOCATION_CDM : Component, ICachedReport {
        
        public CachedLOCATION_CDM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LOCATION_CDM rpt = new LOCATION_CDM();
            rpt.Site = this.Site;
            return rpt;
        }
