...
namespace GHB_D1.ReportFiles {
    ...
    public class RATM7001_ATM : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.RATM7001_ATM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRATM7001_ATM : Component, ICachedReport {
        
        public CachedRATM7001_ATM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RATM7001_ATM rpt = new RATM7001_ATM();
            rpt.Site = this.Site;
            return rpt;
        }
