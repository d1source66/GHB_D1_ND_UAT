...
namespace GHB_D1.ReportFiles {
    ...
    public class CDM_FEE_AMT : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.CDM_FEE_AMT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCDM_FEE_AMT : Component, ICachedReport {
        
        public CachedCDM_FEE_AMT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CDM_FEE_AMT rpt = new CDM_FEE_AMT();
            rpt.Site = this.Site;
            return rpt;
        }
