...
namespace GHB_D1.ReportFiles {
    ...
    public class CDM7001_ORFT : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GHB_D1.ReportFiles.CDM7001_ORFT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCDM7001_ORFT : Component, ICachedReport {
        
        public CachedCDM7001_ORFT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CDM7001_ORFT rpt = new CDM7001_ORFT();
            rpt.Site = this.Site;
            return rpt;
        }
